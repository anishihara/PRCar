...
def smooth(path, weight_data = 0.1, weight_smooth = 0.1, tolerance = 0.00001):
    ...
    while reached == False:
        ...
        for i in range(len(newpath)):
            ...
            if i == 0:
                newpath[i][0] = newpath[i][0] + weight_smooth * (newpath[i+1][0] + newpath[len(newpath)-1][0] - 2 * newpath[i][0])
            elif i == len(newpath)-1:
                newpath[i][0] = newpath[i][0] + weight_smooth * (newpath[0][0] + newpath[i-1][0] - 2 * newpath[i][0])
            else:
            ...
            if i == 0:
                newpath[i][1] = newpath[i][1] + weight_smooth * (newpath[i+1][1] + newpath[len(newpath)-1][1] - 2 * newpath[i][1])
            elif i == len(newpath)-1:
                newpath[i][1] = newpath[i][1] + weight_smooth * (newpath[0][1] + newpath[i-1][1] - 2 * newpath[i][1])
            else:
